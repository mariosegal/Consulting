...
%macro create_report(class1=,fmt1=,condition=,main_source=,contrib_source=,out_file=,out_dir=,logo_file=) / ;
%put _user_;
...
%* Massage data for boxplots;
 ...
 %*Generate the charts;
	...
	vbar prod / missing group=proxy groupdisplay=cluster response=col2 nostatlabel grouporder=data 
	...
	keylegend / TITLEATTRS=(family=Arial Weight=Bold) valueattrs=(family=Arial ) title="";
	...
	vbar prod / missing group=proxy groupdisplay=cluster response=col3 nostatlabel grouporder=data 
	...
	keylegend / TITLEATTRS=(Weight=Bold) title="";
	...
	vbar &class1 / missing group=proxy groupdisplay=cluster response=col1 nostatlabel grouporder=data 
	           datalabel DATALABELATTRS=(Size=6);
	...
	vbar prod / missing group=proxy groupdisplay=cluster response=col1 nostatlabel grouporder=data 
	           datalabel DATALABELATTRS=(Size=6);
	xaxis label='Product' LABELATTRS=(Weight=Bold)   tickvalueformat=DATA type=discrete discreteorder=data 
	      fitpolicy=stagger;
	yaxis label='Average Contribution' LABELATTRS=(Weight=Bold) ;
	...
	vbar segment / missing group=proxy groupdisplay=cluster response=hh_sum  stat=sum  grouporder=data nostatlabel  datalabel DATALABELATTRS=(Size=6) name="A";
	vbar segment / missing group=proxy groupdisplay=cluster response=pct stat=sum  nostatlabel grouporder=data datalabel  DATALABELATTRS=(Size=6) name="B";
	...
	keylegend "A" / title="";
	format  pct percent6. hh_sum comma12.;
	run;
	%end;
	%else %do;
	...
	vbar tran_code / missing group=proxy groupdisplay=cluster response=hh_sum  stat=sum  grouporder=data nostatlabel  datalabel DATALABELATTRS=(Size=6) name="A";
	vbar tran_code / missing group=proxy groupdisplay=cluster response=pct stat=sum  nostatlabel grouporder=data datalabel  DATALABELATTRS=(Size=6) name="B";
	xaxis label='Customer Lifecycle Segment' LABELATTRS=(Weight=Bold) tickvalueformat=DATA type=discrete discreteorder=data fitpolicy=stagger;
	yaxis label='Number of HHs' LABELATTRS=(Weight=Bold) ;
	keylegend "A" / title="";
	format  pct percent6. hh_sum comma12.;
	...
	vbar band / missing group=proxy groupdisplay=cluster response=hh_sum  stat=sum  grouporder=data nostatlabel  datalabel DATALABELATTRS=(Size=6) name="A";
	vbar band / missing group=proxy groupdisplay=cluster response=pct stat=sum  nostatlabel grouporder=data datalabel  DATALABELATTRS=(Size=6) name="B";
	...
	vbar distance / missing group=proxy groupdisplay=cluster response=hh_sum  stat=sum  grouporder=data nostatlabel  datalabel DATALABELATTRS=(Size=6) name="A";
	vbar distance / missing group=proxy groupdisplay=cluster response=pct stat=sum  nostatlabel grouporder=data datalabel  DATALABELATTRS=(Size=6) name="B";
	...
	vbar tenure_yr / missing group=proxy groupdisplay=cluster response=hh_sum  stat=sum  grouporder=data nostatlabel  datalabel DATALABELATTRS=(Size=6) name="A";
	vbar tenure_yr / missing group=proxy groupdisplay=cluster response=pct stat=sum  nostatlabel grouporder=data datalabel  DATALABELATTRS=(Size=6) name="B";
	...
	vbar cbr / missing group=proxy groupdisplay=cluster response=hh_sum  stat=sum  grouporder=data nostatlabel  datalabel DATALABELATTRS=(Size=6) name="A";
	vbar cbr / missing group=proxy groupdisplay=cluster response=pct stat=sum  nostatlabel grouporder=data datalabel  DATALABELATTRS=(Size=6) name="B";
...
%macro penetration(class1=,class2=,class3=,fmt1=,fmt2=,fmt3=,where=,main_source=,out=) /   des='product poenetration and balances tables';
...
%macro contribution(class1=,class2=,class3=,fmt1=,fmt2=,fmt3=,where=,main_source=,contrib_source=,out=) /   des='contribution tables';
...
%macro segments(class1=,class2=,class3=,fmt1=,fmt2=,fmt3=,where=,main_source=,out=)/   des='assorted descriptrive tables';
...
%macro balance_box(main_source=,contrib_source=,condition=,class1=,fmt1=) / ;
...
%macro contrib_box(main_source=,contrib_source=,condition=,class1=,fmt1=) / ;
...
%macro vbox_template (templ_name=template1,title=,ylabel=)/ ;
	proc template;
