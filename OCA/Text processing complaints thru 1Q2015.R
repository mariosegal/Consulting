...
comments = tolower(complaints_2014_2015Q1_matched_both$comment)
...
save(corpus1,file='Z:/M&T Projects/OCA/corpus1_1Q2015.rdata')
dtm <- DocumentTermMatrix(corpus1)
#dtm
dtm1 <- removeSparseTerms(dtm,0.995)
dtm1
words_1q2015 = as.data.frame(as.matrix(dtm1))
words_1q2015$complaint_master_id = complaints_2014_2015Q1_matched_both$complaint_master_id
words_1q2015$incident_id =  complaints_2014_2015Q1_matched_both$incident_id
save(words_1q2015,file='Z:/M&T Projects/OCA/words_1q2015.rdata')

#NGRAMS
library(tau)
a <- sapply(1:length(corpus1),function(x) corpus1[[x]]$content)
a1 = data.frame(id=complaints_2014_2015Q1_matched_both$complaint_master_id,text=a,stringsAsFactors = F)
...
save(ngrams2,file='Z:/M&T Projects/OCA/ngrams2_1q2015.rdata')
...
save(ngrams3,file='Z:/M&T Projects/OCA/ngrams3_1Q2015.rdata')
...
save(ngrams4,file='Z:/M&T Projects/OCA/ngrams4_1Q_2015.rdata')
...
save(ngrams5,file='Z:/M&T Projects/OCA/ngrams5_1Q2015.rdata')

save(ngrams2,ngrams3,ngrams4,ngrams5,words_1q2015,file='Z:/M&T Projects/OCA/text_analysis_datasets_20150525.rdata')
